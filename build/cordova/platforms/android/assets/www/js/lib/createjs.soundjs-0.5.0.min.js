...
this.createjs = this.createjs || {}, function () {
    ...
    b.src = null, b.uniqueId = -1, b.playState = null, b.owner = null, b.offset = 0, b.delay = 0, b._volume = 1, Object.defineProperty(b, "volume", {get: function () {
        ...
        return this.owner.capabilities.panning && null != Number(a) ? (a = Math.max(-1, Math.min(1, a)), this._pan = a, this.panNode.setPosition(a, 0, -.5), void 0) : !1
        ...
        if (this.paused || null == this.sourceNode)var a = this.offset; else var a = this.owner.context.currentTime - this.startTime;
        return 1e3 * a
    ...
    c.capabilities = null, c.audioSources = null, c.defaultNumChannels = 2, c.loadedHandler = null, c.init = function () {
        ...
        if (d.id = a, this.loadedHandler = createjs.proxy(this.handleTagLoad, this), d.addEventListener && d.addEventListener("canplaythrough", this.loadedHandler), null == d.onreadystatechange)d.onreadystatechange = this.loadedHandler; else {
    ...
    b.src = null, b.uniqueId = -1, b.playState = null, b.owner = null, b.loaded = !1, b.offset = 0, b.delay = 0, b._volume = 1, Object.defineProperty(b, "volume", {get: function () {
        ...
        if (null == this.tag)this.offset = a; else {
